...
<div class="row form-group">
    ...
    <div class="col-5"><input type="text" name="date_start" id="date_start" placeholder="from ..." class="time-picker form-control" value="{{@$_POST['date_start']}}"></div>
    <div class="col-5"><input type="text" name="date_end" id="date_end" placeholder="to" class="time-picker form-control" value="{{@$_POST['date_end']}}"></div>
